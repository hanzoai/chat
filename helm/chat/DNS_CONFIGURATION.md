# DNS Configuration for Chat Helm Chart

This feature allows you to configure custom DNS settings for Chat pods, enabling traffic redirection to proxy servers or custom endpoints.
...
Deploy:
```bash
helm upgrade --install chat ./helm/chat -f values.yaml
```
...
✅ **Integration Test**
- Works with existing Chat configuration
...
- Kubernetes 1.19+
- Compatible with all Chat deployment modes
