...
const { agentSchema } = require('@chat/data-schemas');
...
/**
 * @type {import('mongoose').Model<import('@chat/data-schemas').IAgent>}
 */
let Agent;
...
describe('models/Agent', () => {
  ...
  describe('Agent CRUD Operations', () => {
    ...
    test('should handle ephemeral agent loading', async () => {
      ...
      const originalModule = jest.requireActual('chat-data-provider');
      ...
      jest.doMock('chat-data-provider', () => mockDataProvider);

      expect(agentId).toBeDefined();
      expect(endpoint).toBeDefined();

      jest.dontMock('chat-data-provider');
    });
  ...
  describe('Load Agent Functionality', () => {
    ...
    test('should test ephemeral agent loading logic', async () => {
      const { EPHEMERAL_AGENT_ID } = require('chat-data-provider').Constants;
