          ...
          <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  {selectedRole === SystemRoles.ADMIN && agentPerm === Permissions.USE && (
                    <>
                      <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                        ...
                        {'\n'}
                        <a
                          href="https://www.hanzo.ai/docs/configuration/chat_yaml/object_structure/interface"
                          target="_blank"
                          rel="noreferrer"
            ...
            <div className="flex justify-end">
              <button
                ...
                className="btn rounded border border-gray-300 bg-white font-bold text-black transition-all hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
              >
