  ...
  return (
    <SelectDropDown
      ...
      className={cn(
        ...
        'z-50 flex h-[40px] w-full flex-none items-center justify-center px-4 hover:cursor-pointer hover:border-black focus:border-gray-400 dark:hover:border-white',
      )}
      renderOption={() => (
