...
import { TFile } from '@hanzochat/data-provider/dist/types';
  ...
  return (
    <div className="m-3 ml-1 mr-7 bg-white p-2 sm:p-4 md:p-6 lg:p-10">
      ...
      <div className="mt-3 flex flex-col">
        ...
        <div className="mt-3 flex flex-row">
          <span className="flex w-1/2 flex-row items-center md:w-2/5">
            ...
            &nbsp;{localize('com_ui_usage_this_month')}
          </span>
          <div className="w-1/2 md:w-3/5">
            <p className="text-gray-500">
              <span className="text-[#91c561]">{localize('com_ui_kb_hours', { amount: '0' })}</span>
              &nbsp; {localize('com_ui_free_until_date', { date: '2024' })}
            </p>
          </div>
        </div>
        <div className="mt-3 flex flex-row">
          ...
          <span className="w-1/2 text-gray-500 md:w-3/5">
            {localize('com_ui_bytes', { bytes: vectorStore.bytes })}
          </span>
        </div>
        <div className="mt-3 flex flex-row">
          <span className="flex w-1/2 flex-row items-center md:w-2/5">
            <Clock3 className="text-base text-gray-500 md:text-lg lg:text-xl" />
            &nbsp;{localize('com_ui_last_active')}
          </span>
        ...
        <div className="mt-3 flex flex-row">
          <span className="flex w-1/2 flex-row items-center md:w-2/5">
            <InfoIcon className="text-base text-gray-500 md:text-lg lg:text-xl" />
            &nbsp;{localize('com_ui_expiration_policy')}
          </span>
      ...
      <div className="mt-10 flex flex-col">
        <div>
          <b className="text-base md:text-lg lg:text-xl">{localize('com_ui_files_attached')}</b>
        </div>
      ...
      <div className="mt-10 flex flex-col">
        <div className="flex flex-row justify-between">
          <b className="text-base md:text-lg lg:text-xl">{localize('com_ui_used_by')}</b>
