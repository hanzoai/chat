...
const EditMessage = ({
  ...
  return (
    <Container message={message}>
      <div className="relative mt-2 flex w-full flex-grow flex-col overflow-hidden rounded-2xl border border-border-medium bg-presentation text-text-primary [&:has(textarea:focus)]:border-border-heavy [&:has(textarea:focus)]:shadow-[0_2px_6px_rgba(0,0,0,.05)]">
        <TextareaAutosize
          {...registerProps}
          ref={(e) => {
            ref(e);
          ...
          className={cn(
            'markdown prose dark:prose-invert whitespace-pre-wrap break-words pl-3 md:pl-4',
