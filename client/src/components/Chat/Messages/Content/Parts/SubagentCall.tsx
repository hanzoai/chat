...
import type { TAttachment, TMessage, TMessageContentParts } from '@hanzochat/data-provider';
...
function SubagentPrompt({
  ...
  return (
    ...
    >
      ...
      >
        <div className="markdown prose prose-sm message-content dark:prose-invert w-full max-w-none break-words text-text-primary dark:text-gray-100">
