...
import { Button, CrossIcon, useOnClickOutside } from '@hanzochat/client';
...
export default function OptionsPopover({
  ...
  const cardStyle =
    'glass elevation-2 rounded-md min-w-[75px] font-normal border-border-medium border text-text-primary';
      ...
      <Content sideOffset={8} align="start" ref={popoverRef} asChild>
        <div className="z-[70] flex w-screen flex-col items-center md:w-full md:px-4">
          <div
            className={cn(
              cardStyle,
              'border-d-0 flex w-full flex-col overflow-hidden rounded-none border-s-0 border-t px-0 pb-[10px] md:rounded-md md:border lg:w-[736px]',
            )}
          >
