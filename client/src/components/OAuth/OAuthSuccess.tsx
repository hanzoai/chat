...
export default function OAuthSuccess() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-surface-primary p-8">
      <div className="elevation-1 w-full max-w-md rounded-xl border border-border-light bg-surface-secondary p-8 text-center">
        ...
        <p className="mb-2 text-sm text-text-secondary">
          ...
          <span className="font-medium text-text-primary">{secondsLeft}</span>{' '}
