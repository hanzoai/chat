...
declare class RequestConfig {
    ...
    readonly parameterLocations?: Record<string, "query" | "path" | "header" | "body"> | undefined;
    constructor(domain: string, basePath: string, method: string, operation: string, isConsequential: boolean, contentType: string, parameterLocations?: Record<string, "query" | "path" | "header" | "body"> | undefined);
}
