...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'chat-westus'
    expect(groupMap).toHaveProperty('chat-westus');
    expect(groupMap['chat-westus']).toEqual(
    ...
    // Check groupMap for 'chat-eastus'
    expect(groupMap).toHaveProperty('chat-eastus');
    expect(groupMap['chat-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'chat-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'chat-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'chat-eastus',
