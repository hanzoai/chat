# Dynamic Theme System for @hanzochat/client
...
```bash
npm install @hanzochat/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@hanzochat/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@hanzochat/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@hanzochat/client';
...
```tsx
import { useTheme } from '@hanzochat/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@hanzochat/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@hanzochat/client';
...
This theme system is part of the @hanzochat/client package. 