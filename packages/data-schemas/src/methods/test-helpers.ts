/**
 * Inlined utility functions previously imported from @hanzochat/api.
 ...
 *
 * Inlined from @hanzochat/api findMatchingPattern
 */
 ...
 *
 * Inlined from @hanzochat/api matchModelName (simplified for test use)
 */
