...
declare const projectSchema: Schema<IMongoProject, import("mongoose").Model<IMongoProject, any, any, any, Document<unknown, any, IMongoProject, any, {}> & IMongoProject & Required<{
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, IMongoProject, Document<unknown, {}, import("mongoose").FlatRecord<IMongoProject>, {}, import("mongoose").DefaultSchemaOptions> & import("mongoose").FlatRecord<IMongoProject> & Required<{
    _id: Types.ObjectId;
}> & {
    __v: number;
}>;
