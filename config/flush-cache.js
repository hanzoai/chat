...
/**
 * Chat Cache Flush Utility
 *
 * This script flushes the cache store used by Chat, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Chat. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Chat backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Chat Cache Flush Utility');
  console.log('================================');
