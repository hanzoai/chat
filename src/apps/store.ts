...
const DEFAULT_TODOS: TodoItem[] = [
  ...
  {
    id: 'todo-3',
    text: 'Wire real-time WebRTC audio room with @chat AI conversation transcription',
    completed: false,
    assignedAgent: '@dev',
    priority: 'P1',
    dueDate: 'Tomorrow',
...
const DEFAULT_MEETING: MeetingSession = {
  ...
  activeParticipants: [
    ...
    { id: 'agent_chat', name: '@chat (AI)', isMuted: true, isCameraOn: false, isAgent: true },
  ],
  transcript: [
    ...
    { speaker: '@chat', text: '✓ Action item logged: Ephemeral ZT tunnel exposed to team.', timestamp: '10:44 AM' },
  ],
