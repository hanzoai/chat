...
/** Must match the `e2e-http` server URL in e2e/config/chat.e2e.yaml. */
...
const configTemplatePath = path.resolve(rootPath, 'e2e/config/chat.e2e.yaml');
const configPath = path.resolve(rootPath, 'e2e/.generated/chat.e2e.yaml');
